        ...
        <div className="flex flex-col items-center gap-2 mb-6">
          {window.location.port === '5173' ? (
            <GoogleLogin
              ...
              onError={() => setGoogleError("Google Sign-In non disponible sur localhost.")}
              theme="filled_black"
              shape="rectangular"
              text="continue_with"
            />
          ) : (
            <p className="text-xs text-center text-gray-400">Connexion Google disponible en production uniquement</p>
          )}
          {googleError && (
