...
export default function UserForm() {
  ...
  const [formData, setFormData] = useState({
    username: '', email: '', fullName: '', role: 'ROLE_MANAGER', enabled: true, password: ''
  });
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-lg px-4 py-2 text-gray-900 dark:text-white outline-none"
            >
