  ...
  return (
    <motion.button
      ...
      className={`
        ...
        ${isExporting
          ? 'bg-gray-100 dark:bg-noir-800 border-gray-200 dark:border-glass-border text-gray-400 dark:text-text-muted cursor-not-allowed'
          : 'bg-uib-red border-uib-red text-white hover:bg-red-700'
        }
      `}
    >
      {isExporting ? (
