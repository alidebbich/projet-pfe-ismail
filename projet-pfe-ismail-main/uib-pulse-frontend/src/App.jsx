...
import QualiteDashboard from './pages/dashboard/QualiteDashboard';
import AvancementDashboard from './pages/dashboard/AvancementDashboard';
      ...
      <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<DashboardLayout />}>
            ...
            <Route path="/dashboard/qualite" element={<QualiteDashboard />} />
            <Route path="/dashboard/avancement" element={<AvancementDashboard />} />
            ...
            <Route element={<AdminRoute />}>
              ...
              <Route path="/admin/user-profiles" element={<UserProfilesPage />} />
