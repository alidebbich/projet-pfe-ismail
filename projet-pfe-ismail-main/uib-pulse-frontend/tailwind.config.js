  ...
  theme: {
    extend: {
      colors: {
        // UIB Brand Red
        'uib-red': '#E2001A',
        'uib-red-dim': 'rgba(226, 0, 26, 0.12)',
        'uib-red-glow': 'rgba(226, 0, 26, 0.25)',

        // Lombard Odier inspired — premium green
        'lo-green': '#1D6B4E',
        'lo-green-dim': 'rgba(29, 107, 78, 0.12)',

        // UIB Navy (Société Générale)
        'uib-navy': '#1C3A5E',
        'uib-navy-dim': 'rgba(28, 58, 94, 0.08)',

        // Warm ivory backgrounds (Lombard Odier style)
        'ivory': '#F7F4EF',
        'ivory-dark': '#EDE9E1',
      ...
      boxShadow: {
        'glass': '0 2px 12px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,0.06)',
        'red-glow': '0 2px 8px rgba(226, 0, 26, 0.2)',
        'red-glow-sm': '0 1px 4px rgba(226, 0, 26, 0.15)',
        'green-glow': '0 2px 8px rgba(34, 197, 94, 0.15)',
        'orange-glow': '0 2px 8px rgba(245, 158, 11, 0.15)',
      },
